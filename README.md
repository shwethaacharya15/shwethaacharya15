...
<h3 align="center">💥 Junior QA Engineer | Passionate About Web, Mobile & API Test Automation</h3>
...
- 🔭 Currently mastering **API Automation with Java (RestAssured)**
- 🚀 Hands-on with **Playwright, Cypress, Appium, and Manual Testing**
- 🔍 Skilled in **API validation, UI regression, and functional testing**
- 🧠 Exploring **framework design, reusable test utilities, and CI/CD pipelines**
- 💡 Experience across **Web, Mobile, and API** platforms
- 🎯 Goal: To become a **Full-Stack Test Automation Specialist** skilled in Web, Mobile & API automation
...
- **Automation Tools:** Playwright | Cypress | Appium | RestAssured  
- **Testing Types:** Functional | Regression | Cross-browser | API  
- **Languages:** Java | Python | JavaScript  
- **CI/CD Tools:** GitHub Actions | Jenkins  
- **Test Management:** Jira | TestRail | JAM  
...
### 📊 GitHub Stats
<p align="center">
<a href="https://github.com/shwethaacharya15">
...
⭐ **“Testing is not about finding bugs; it’s about making things work better.”**
